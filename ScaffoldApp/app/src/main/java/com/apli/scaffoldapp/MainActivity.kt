...
import com.apli.scaffoldapp.ui.theme.ScaffoldAppTheme
...
@Composable
fun MyTopAppBar(openDrawer: () -> Job) {
    TopAppBar(
        ...
        actions = {
            IconButton(onClick = {openDrawer()}) { Icon(Icons.Filled.Add, contentDescription = "Desc") }
